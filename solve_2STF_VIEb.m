function [u, uext] = solve_2STF_VIEb(m_Gamma, m_Omega, pts, in, k0, k, ikO,  kx, ax, grad_ax, tol, theta)
...
[A0, A1]     = build_2STFb(m_Gamma, k0, kO, ax, alpha, tol);
[Av, Ad, An] = build_2VIOb(m_Gamma, m_Omega, kO, beta, aO, ax, grad_ax, alpha, tol);
[S, D]       = build_potentials2(m_Gamma, m_Omega, kO);
F            = build_rhs2b(m_Gamma, m_Omega, k0, k, theta, ax, aO);
