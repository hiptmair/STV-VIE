function [Av, Ad, An] = build_VIObb(m_Gamma, m_Omega, k, beta,aO, ax, grad_ax, alpha, tol)
...
% aux = hmx(double(m_Omega.vtx), double(m_Omega.vtx), Beta - k^2 * Alpha, tol);
