function [Av, Ad, An] = build_VIOb(m_Gamma, m_Omega, k, beta,aO, ax, grad_ax, alpha, tol)
...
%%% Minus sign: change of variable div_y to div_x
%%% Minus sign: n dot grad a / a
divKdir = Mu' * Mult * Wq * (divKdir{1} + reg{1}) * DxAlpha + Mu' * Mult * Wq * (divKdir{2} + reg{2}) * DyAlpha;
