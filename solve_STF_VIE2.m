function [u, uext] = solve_STF_VIE2(m_Gamma, m_Omega, pts, in, k0, k, kx, ax, tol, theta)
...
[A0, A1]     = build_STF2(m_Gamma, k0, kO, ax, alpha, tol);
[Av, Ad, An] = build_VIO2(m_Gamma, m_Omega, kO, beta, ax, alpha, tol);
[S, D]       = build_potentials(m_Gamma, m_Omega, kO);
F            = build_rhs(m_Gamma, m_Omega, k0, k, theta, ax);
